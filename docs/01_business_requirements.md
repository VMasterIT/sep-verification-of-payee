...
**Поточний стан:**
- Високий відсоток платежів з невірними реквізитами (5-10% від загальної кількості)
- Складність повернення помилково відправлених коштів
- Збільшення випадків шахрайства через помилкові перекази
...
- Репутаційні ризики для банків
- Додаткові витрати на обробку повернень
- Зниження успішності платіжних операцій
...
- Обов'язково для всіх банків з 2024

**EU Verification of Payee:**
- Регламент 2024/886
- Обов'язково з 9 жовтня 2025
- Інтеграція з SEPA Instant Payments
- Використання EPC Directory Service
...
- Передається EDRPOU замість ІПН
...
**Дата:** 2026-02-06
**Статус:** Draft
**Автор:** Департамент платіжних систем НБУ
