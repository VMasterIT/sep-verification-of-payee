...
| `scenarios/scenario-2-close-match.md` | ⏳ TODO | Часткове співпадіння |
| `scenarios/scenario-3-error-handling.md` | ⏳ TODO | Обробка помилок |

### 🔐 Безпека (security/)

| Файл | Статус | Опис |
|------|--------|------|
| `mtls-setup.md` | ⏳ TODO | Налаштування mTLS |
| `certificate-management.md` | ⏳ TODO | Управління сертифікатами |
| `oauth2-fapi-config.md` | ⏳ TODO | OAuth 2.0 + FAPI |
...
### Пріоритет 2: Важливі (2-4 тижні)

- [ ] `examples/scenarios/scenario-2-close-match.md`
- [ ] `examples/scenarios/scenario-3-error-handling.md`
- [ ] `security/mtls-setup.md`
- [ ] `security/certificate-management.md`
- [ ] `security/oauth2-fapi-config.md`
- [ ] `docs/06_integration_scenarios.md`
...
⏳ Security документація (mtls, certificates, oauth2)
...
**НБУ — Департамент платіжних систем та інноваційного розвитку**
...
**Версія:** 1.1
**Дата:** 2026-02-06
**Статус:** Draft / Core Documentation Complete (51%)

**Останнє оновлення:** Завершено всі документи Пріоритету 1

Наступне оновлення: після створення документів Пріоритету 2
